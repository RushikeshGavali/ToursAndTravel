            ...
            <div className='container s1'>
                <center>
                    ...
                    <form>
                        ...
                        <div className="row form_submit">
                            <div className="col-lg-3 simple"><label class='label_text' htmlFor='password1'><b>Confirm
                        ...
                        <button type="submit" className="button button1" onClick={this.handleOnSubmit}>Submit</button>
                    </form>
                </center>
            </div>
