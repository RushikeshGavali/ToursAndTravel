...
function ViewDetails(props) {
  ...
  const bookNowHandler = () => {
    props.history.push({
      pathname:
        "/BookNow/" +
        info[props.match.params.id].adultPrice +
        "/" +
        info[props.match.params.id].childPrice +
        "/" +
        info[props.match.params.id].location +
        "/" +
        info[props.match.params.id].departureDate,
    });
  };
  return (
    <div>
      ...
      <div className="viewContainer">
        <div>
          <img
            src={info[props.match.params.id].imageSrc}
            alt="North goa"
            className="viewImage"
          ></img>
        </div>
        ...
        <div className="viewData">
          ...
          <h5>Number of days : {info[props.match.params.id].noOfDays}</h5>
          <br></br>
